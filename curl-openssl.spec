...
* Fri Feb 03 2012 Scott Cantor <cantor.2@osu.edu> 7.24.0-1
- update version

* Sat Jun 25 2011 Scott Cantor <cantor.2@osu.edu> 7.21.7-1
- switch from Red Hat to upstream sources
- install into /opt/shibboleth

* Thu May 19 2011 Scott Cantor <cantor.2@osu.edu> 7.19.7-26.1
...
* Tue Nov 23 2010 Scott Cantor <cantor.2@osu.edu> 7.19.7-17.1
- rename packages and adjust build to use openssl for RH6
